    ...
    >
      <g id="Layer_1">
        <g id="Layer_1">
          <path
            style={st0Style}
            d="M58.8,180.8c-1.5,0-2.7,2.6-2.7,5.8s1.2,5.8,2.7,5.8h169.3c1.5,0,2.7-2.6,2.7-5.8s-1.2-5.8-2.7-5.8H58.8z"
          />
          <path
            d="M380.6,364.6c3.2,0,5.8-2.6,5.8-5.8V157.5c0-3.2-2.6-5.8-5.8-5.8c-3.2,0-5.8,2.6-5.8,5.8v199.1h-5.4V157.5
			c0-3.2-2.6-5.8-5.8-5.8c-3.2,0-5.8,2.6-5.8,5.8v201.3c0,3.2,2.6,5.8,5.8,5.8L380.6,364.6L380.6,364.6z"
          />
          <path
            d="M51.2,364.6c3.2,0,5.8-2.6,5.8-5.8V157.5c0-3.2-2.6-5.8-5.8-5.8s-5.8,2.6-5.8,5.8v199.1h-5.4V157.5c0-3.2-2.6-5.8-5.8-5.8
			s-5.8,2.6-5.8,5.8v201.3c0,3.2,2.6,5.8,5.8,5.8L51.2,364.6L51.2,364.6z"
          />
          <path
            d="M357.9,163.3H233.2v51h124.6V163.3L357.9,163.3z M227.5,151.8h136.2c3.2,0,5.8,2.6,5.8,5.8v62.6c0,3.2-2.6,5.8-5.8,5.8
			H227.5c-3.2,0-5.8-2.6-5.8-5.8v-62.6C221.7,154.4,224.3,151.8,227.5,151.8z"
          />
          <path
            d="M363.6,288.4H227.5c-3.2,0-5.8-2.6-5.8-5.8v-62.5c0-3.2,2.6-5.8,5.8-5.8h136.2c3.2,0,5.8,2.6,5.8,5.8v62.5
			C369.4,285.8,366.8,288.4,363.6,288.4L363.6,288.4z M233.2,276.9h124.6v-51H233.2V276.9z"
          />

          <ellipse
            transform="matrix(0.9871 -0.1602 0.1602 0.9871 -26.4292 49.7862)"
            class="st0"
            cx="295.6"
            cy="188.8"
            rx="8"
          ...
          <path
            d="M50.2,0h173.2c2,0,3.9,0.8,5.2,2.2l0,0c1.3,1.3,2.2,3.2,2.2,5.2v104.5c0,2-0.8,3.9-2.2,5.2s-3.2,2.2-5.2,2.2H50.2
          ...
          <path
            d="M417.1,140.6c0-3.2-2.6-5.8-5.8-5.8H210c-3.2,0-5.8,2.6-5.8,5.8s2.6,5.8,5.8,5.8h199.1v5.4H210c-3.2,0-5.8,2.6-5.8,5.8
			s2.6,5.8,5.8,5.8h201.3c3.2,0,5.8-2.6,5.8-5.8L417.1,140.6L417.1,140.6z"
          />
          <path
            d="M0,157.5c0,3.2,2.6,5.8,5.8,5.8h201.3c3.2,0,5.8-2.6,5.8-5.8s-2.6-5.8-5.8-5.8H8v-5.4h199.1c3.2,0,5.8-2.6,5.8-5.8
